...
public class FileService {
	 ...
	 * @return json
	 */
	public static JSONObject uploadFile(String fileType, String filename, String filePath,String access_token) {

		String requestUrl = uploadFileUrl.replace("ACCESS_TOKEN",
				access_token).replace("TYPE", fileType);
	...
	public static String downloadFile(String mediaId ,String access_token) {
		return dwonloadFileURL.replace("ACCESS_TOKEN", access_token)
