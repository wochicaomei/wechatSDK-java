...
@Entity
@Table(name = "t_app_chatroom")
public class ChatRoom extends AbstractPo implements Serializable {
	@Id
	@Column(name = "id")
	@GeneratedValue(strategy = GenerationType.IDENTITY)
	private Integer id;

	private String name;// 聊天室主题(唯一)
	private Integer videoId;// 聊天室播放的视频ID(暂时无用)
