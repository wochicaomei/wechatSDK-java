			...
			.widget(
					...
					$.ui.mouse,
					{
						...
						_contactContainers : function(event) {
							var i, j, dist, itemWithLeastDistance, posProperty, sizeProperty, base, cur, nearBottom, innermostContainer = null, innermostIndex = null;
							...
							if (this.containers.length === 1) {
								...
								posProperty = this.containers[innermostIndex].floating ? "left"
										: "top";
		...
		$.fn.extend({
			...
			removeClass : function(classNames, speed, easing, callback) {
				return arguments.length > 1 ? $.effects.animateClass.call(this,
						{
							remove : classNames
						}, speed, easing, callback) : this._removeClass.apply(
						this, arguments);
			},
